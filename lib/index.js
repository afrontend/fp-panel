 ...
 * @param {array} panel - Some items of the 2D array has a color attribute
 ...
 * @param {array} aPanel - Some items of the 2D array has a color attribute
 * @param {array} bPanel - Some items of the 2D array has a color attribute
 ...
 * @param {string} color - a color string, for example 'red', 'orange'
